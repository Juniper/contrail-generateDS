...
'''
    ...
    def _generate_server_impl(self, gen_fname, gen_type_pfx):
        ...
        for ident in self._non_exclude_idents():
            ...
            write(gen_file, "                (ok, result) = db_conn.dbe_read_multi('virtual-network', obj_ids_list, obj_fields)")
            write(gen_file, "                if not ok:")
            write(gen_file, "                    abort(404, result)")
            ...
            write(gen_file, "                        obj_dict['href'] = self.generate_url('virtual-network', obj_result['uuid'])")
