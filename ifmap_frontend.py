...
'''
    ...
    def _generate_server_impl(self, gen_fname, gen_type_pfx):
        ...
        for ident in self._non_exclude_idents():
            ...
            write(gen_file, "        if (result['id_perms'].get('user_visible') is False and")
            ...
            write(gen_file, "                    if obj_result['id_perms'].get('user_visible') is not False:")
            ...
            write(gen_file, "                if (obj_dict['id_perms'].get('user_visible') is not False or ")
